            ...
            Steps=[{
                ...
                'HadoopJarStep': {
                    ...
                    'Args': ['spark-submit',
                            ...
                            '--master', 'yarn',
                            '--deploy-mode', 'cluster',
                            's3://datalake-ib-igti-edc-tf/emr-code/pyspark/01_delta_spark_insert.py'
                        ]
                }
            }],
        )
                ...
                Steps=[{
                    ...
                    'HadoopJarStep': {
                        ...
                        'Args': ['spark-submit',
                                ...
                                '--master', 'yarn',
                                '--deploy-mode', 'cluster',
                                's3://datalake-ib-igti-edc-tf/emr-code/pyspark/02_delta_spark_upsert.py'
                            ]
                    }
                }]
            )
