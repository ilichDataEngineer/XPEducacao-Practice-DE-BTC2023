...
# Cria o diretório e instala as dependências da funcão lambda
if [ -d $PACKAGE ]
then
...
then
    ...
    cp $LAMBDA_FUNCTION .
    echo "Compactando arquivo lambda_fuction_payload.zip"
    7z a -tzip ../lambda_function_payload.zip . #Compacta o pacote para o deploy
